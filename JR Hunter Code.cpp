...
//  JR Code Hunter
// Teacher: Tony Hilton
//  Created by Jose Rodriguez on 10/25/18.
// ***************************************************************
//

#include <cstdlib> // I include the cstdlib library
#include <iostream>
#include <string>
#include <ctime> // I include the time library
using namespace std;


int main()
{
    string textToAnalyze; // I removed the unused interger ( bar & soo)
    int vowels = 0;
    int consonants = 0;
    int digits = 0;
    int spaces = 0;
   ...
   // took out the unnecessary pause string
